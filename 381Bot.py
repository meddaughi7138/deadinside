...
# Bot Details
bot_email = 'This-Is-WALL-E@webex.bot' #Fill in your Teams Bot email#
teams_token = 'ZTc3YTA2MWQtZGM0NC00OGUzLTkyMzMtZjAxZmU4NTMyM2ZiODFhZmM1NTUtYzgz_P0A1_529b5ae9-ae34-46f8-9993-5c34c3d90856' #Fill in your Teams Bot Token#
bot_url = "https://79f9-147-219-51-185.ngrok.io" #Fill in the ngrok forwarding address#
...
def show_run (incoming_msg):
    ...
    """
    response = Response()
    response.text = "Gathering Show Run Inforamtion...\n\n"

    ssh_client= paramiko.SSHClient() # creating an sshclient object  
    ssh_client.set_missing_host_key_policy(paramiko.AutoAddPolicy())
    router = {'hostname': '192.168.56.102', 'port': '22', 'username':'cisco', 'password':'cisco123!'}
...
bot.add_command("show run", "Show the configurations on the device", show_run)
